...
public class BookAdminController {
    ...
    private final BookImportUseCase bookImportUseCase;
    ...
    public ExternalBooksImportResponse importFromOpenLibrary(@RequestBody @Valid ExternalBooksImportRequest request) {
