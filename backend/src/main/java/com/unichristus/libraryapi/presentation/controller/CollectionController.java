...
public class CollectionController {
    ...
    private static final Set<String> ALLOWED_SORTS = Set.of("title", "createdAt", "updatedAt");
    ...
    public Page<CollectionResponse> listCollections(Pageable pageable) {
        return collectionUseCase.listCollections(PageableSanitizer.sanitize(pageable, DEFAULT_SORT, ALLOWED_SORTS));
    }
