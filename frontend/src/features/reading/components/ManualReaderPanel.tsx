    ...
    <article className="card reader-panel reader-panel--manual">
      <div className="section-head">
        <div>
          ...
          <p className="section-sub">
            Este livro está no catálogo local, mas o PDF ainda não está disponível no app. Use o painel de progresso
            para registrar a página em que parou.
          </p>
        </div>
        <span className="kpi reader-source-badge reader-source-badge--manual">Progresso manual</span>
      </div>
      ...
      <div className="reader-unavailable" role="status">
        ...
        <p className="section-sub">
          ...
          histórico, ranking e conquistas pelo registro manual da página.
        </p>
      </div>
